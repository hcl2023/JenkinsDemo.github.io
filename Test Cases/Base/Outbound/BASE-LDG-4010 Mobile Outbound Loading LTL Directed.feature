...
############################################################ 
# Test Case: BASE-LDG-4010 Mobile Outbound Loading LTL Directed.feature
#
...
#
# Input Source: Test Case Inputs/BASE-LDG-4010.csv
# Required Inputs:
...
#
############################################################
Feature: BASE-LDG-4010 Mobile Outbound Loading LTL Directed
...
Given I "setup the environment"
	...
	Then I assign "BASE-LDG-4010" to variable "test_case"
...
@BASE-LDG-4010
Scenario Outline: BASE-LDG-4010 Mobile Outbound Loading LTL Directed
CSV Examples: Test Case Inputs/BASE-LDG-4010.csv
...
When I "perform directed LTL loading operation"
	And I execute scenario "Mobile Perform LTL Directed Loading of All LPNs for Truck"
