...
############################################################ 
# Test Case: BASE-LDG-4040 Mobile Outbound Loading TL Undirected.feature
#
...
#
# Input Source: Test Case Inputs/BASE-LDG-4040.csv
# Required Inputs:
...
#
############################################################
Feature: BASE-LDG-4040 Mobile Outbound Loading TL Undirected
...
Given I "setup the environment"
	...
	Then I assign "BASE-LDG-4040" to variable "test_case"
...
@BASE-LDG-4040
Scenario Outline: BASE-LDG-4040 Mobile Outbound Loading TL Undirected
CSV Examples: Test Case Inputs/BASE-LDG-4040.csv

Given I "execute pre-test scenario actions (including pre-validations)"
	And I execute scenario "Begin Pre-Test Activities"

Then I "log into the Mobile App and perform TL loading of the trailer"
