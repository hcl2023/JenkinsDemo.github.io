...
############################################################ 
# Test Case: BASE-SHP-1120 Web Outbound Close Load with Safety Questions.feature
#
...
# 
############################################################ 
Feature: BASE-SHP-1120 Web Outbound Close Load with Safety Questions
...
Given I "setup the environment"
	...
	Then I assign "BASE-SHP-1120" to variable "test_case"
...
@BASE-SHP-1120
Scenario Outline: BASE-SHP-1120 Web Outbound Close Load with Safety Questions
CSV Examples: Test Case Inputs/BASE-SHP-1120.csv
...
And I "close Transport Equipment (including safety check workflow)"
	Then I execute scenario "Web Close Transport Equipment from Door Activity"

And I "validate Web Trailer Closed"
