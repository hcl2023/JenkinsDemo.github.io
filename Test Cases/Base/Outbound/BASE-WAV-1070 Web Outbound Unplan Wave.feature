...
############################################################ 
# Test Case: BASE-WAV-1070 Web Outbound Unplan Wave.feature
#
...
#
# Input Source: Test Case Inputs/BASE-WAV-1070.csv
# Required Inputs: 
...
# 
############################################################ 
Feature: BASE-WAV-1070 Web Outbound Unplan Wave
...
Given I "setup the environment"
	...
	Then I assign "BASE-WAV-1070" to variable "test_case"
...
@BASE-WAV-1070
Scenario Outline: BASE-WAV-1070 Web Outbound Unplan Wave
CSV Examples: Test Case Inputs/BASE-WAV-1070.csv
...
When I "perform an Web Unplan Wave operation"
	Then I execute scenario "Web Unplan Wave"
    
And I "validate wave was unplanned"
	Then I execute scenario "Validate Wave Unplan"
