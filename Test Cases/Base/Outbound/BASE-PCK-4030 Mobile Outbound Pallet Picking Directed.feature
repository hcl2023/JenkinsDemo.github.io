...
############################################################ 
# Test Case: BASE-PCK-4030 Mobile Outbound Pallet Picking Directed.feature
# 
...
#
# Input Source: Test Case Inputs/BASE-PCK-4030.csv
# Required Inputs:
...
#
############################################################
Feature: BASE-PCK-4030 Mobile Outbound Pallet Picking Directed
...
Given I "setup the environment"
	...
	Then I assign "BASE-PCK-4030" to variable "test_case"
...
@BASE-PCK-4030
Scenario Outline: BASE-PCK-4030 Mobile Outbound Pallet Picking Directed
CSV Examples: Test Case Inputs/BASE-PCK-4030.csv

Given I "execute pre-test scenario actions (including pre-validations)"
	And I execute scenario "Begin Pre-Test Activities"
   
Then I "login and navigate to the Directed Work Menu"
