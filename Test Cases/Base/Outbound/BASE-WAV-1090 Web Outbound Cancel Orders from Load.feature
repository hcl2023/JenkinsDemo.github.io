...
############################################################ 
# Test Case: BASE-WAV-1090 Web Outbound Cancel Orders from Load.feature
#
...
#
# Input Source: Test Case Inputs/BASE-WAV-1090.csv
# Required Inputs:
...
#	Example Row: cancel_mode ORDER - cancels the order from the load
#	Example Row: cancel_mode ORDER_LINE - cancels the order line from the load
#
############################################################ 
Feature: BASE-WAV-1090 Web Outbound Cancel Orders from Load
...
Given I "setup the environment"
	...
	Then I assign "BASE-WAV-1090" to variable "test_case"
...
@BASE-WAV-1090
Scenario Outline: BASE-WAV-1090 Web Outbound Cancel Orders from Load
CSV Examples: Test Case Inputs/BASE-WAV-1090.csv
...
And I "Cancel the Order and Order Line"
    Then I execute scenario "Web Cancel Order and Order Line"
    
And I "Validate Order and Order Line Cancelled"
	Then I execute scenario "Web Validate Order and Order Line Cancelled"
