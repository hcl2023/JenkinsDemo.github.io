...
############################################################ 
# Test Case: BASE-LDG-0020 Terminal Outbound Loading LTL Undirected.feature
#
...
#
# Input Source: Test Case Inputs/BASE-LDG-0020.csv
# Required Inputs:
...
#
############################################################
Feature: BASE-LDG-0020 Terminal Outbound Loading LTL Undirected
...
Given I "setup the environment"
	...
	Then I assign "BASE-LDG-0020" to variable "test_case"
...
@BASE-LDG-0020
Scenario Outline: BASE-LDG-0020 Terminal Outbound Loading LTL Undirected
CSV Examples: Test Case Inputs/BASE-LDG-0020.csv

Given I "execute pre-test scenario actions (including pre-validations)"
	And I execute scenario "Begin Pre-Test Activities"

Then I "login into the terminal and perform ltl loading of the trailer"
	And I execute scenario "Terminal Login"
	And I execute scenario "Terminal Navigate to LTL Load Menu"
	When  I execute scenario "Terminal Perform Undirected LTL Loading"
