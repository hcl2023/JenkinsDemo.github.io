...
############################################################ 
# Test Case: BASE-LDG-6000 Flow Mobile Outbound Audit.feature
#
...
#
# Description: 
# This test case performs an outbound inventory audit in the Mobile App. If a discrepancy is found,
# a re-count will occur, followed by a release of hold completed in the Web. It will also check the RF
# Outbound audit history and loads, closes, and dispatches the trailer.
#
# Input Source: Test Case Inputs/BASE-LDG-6000.csv
# Required Inputs:
...
#
############################################################
Feature: BASE-LDG-6000 Flow Mobile Outbound Audit
...
Given I "setup the environment"
	...
	Then I assign "BASE-LDG-6000" to variable "test_case"
...
And I "load the dataset"
    ...
    If I verify variable "mobile_devcod" is assigned
		...
		And I assign variable "devcod" by combining $mobile_devcod
...
@BASE-LDG-6000
Scenario Outline: BASE-LDG-6000 Flow Mobile Outbound Audit
CSV Examples: Test Case Inputs/BASE-LDG-6000.csv

Given I "execute pre-test scenario actions (including pre-validations)"
	And I execute scenario "Begin Pre-Test Activities"

Then I "log into Mobile App and navigate to the outbound audit menu"
	And I execute scenario "Mobile Login"
	And I execute scenario "Mobile Shipping Manual Outbound Audit Menu"

When I "perform the outbound audit in the Mobile App"
	And I execute scenario "Mobile Outbound Audit"
	Then I execute scenario "Mobile Logout"

And I "log into the Web and release hold from the Mobile App audit (if we have discrepancy)"
