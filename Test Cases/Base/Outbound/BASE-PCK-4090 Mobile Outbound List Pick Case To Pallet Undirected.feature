...
############################################################ 
# Test Case: BASE-PCK-4090 Mobile Outbound List Pick Case To Pallet Undirected.feature
# 
...
#
# Input Source:Test Case Inputs/BASE-PCK-4090.csv
# Required Inputs:
...
#
############################################################
Feature: BASE-PCK-4090 Mobile Outbound List Pick Case To Pallet Undirected
...
Given I "setup the environment"
	...
	Then I assign "BASE-PCK-4090" to variable "test_case"
...
@BASE-PCK-4090
Scenario Outline: BASE-PCK-4090 Mobile Outbound List Pick Case To Pallet Undirected
CSV Examples: Test Case Inputs/BASE-PCK-4090.csv

Given I "execute pre-test scenario actions (including pre-validations)"
	And I execute scenario "Begin Pre-Test Activities"
   
Then I "login to the Mobile App and navigate to the Work Assignment screen"
	And I execute scenario "Mobile Login"
	And I execute scenario "Mobile Work Assignment Menu"

When I execute scenario "Mobile Perform Undirected List Pick for Order"
