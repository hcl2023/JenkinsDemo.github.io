...
############################################################ 
# Test Case: BASE-PCK-0110 Terminal Count Near Zero.feature
#
...
#
# Description:
# This Test Case performs Terminal Directed Pallet Picking in a location that has count near zero enabled - and then performs count near zero with different scenarios - (i) Pick and count near zero - no mismatch (ii) Pick and count near zero - mismatch and match (iii) Pick and count near zero - mismatch and mismatch - generate audit
#
# Input Source: Test Case Inputs/BASE-PCK-0110.csv
# Required Inputs:
...
#
# Assumptions:
# - The location specified for this test case is configured to allow pallet picks and has sufficient configuration to generate count near zero. Count near zero in this case will be triggered when there is less than 550 units of a product in the count near zero count zone.
...
#
############################################################
Feature: BASE-PCK-0110 Terminal Count Near Zero
...
Given I "setup the environment"
    ...
    And I execute scenario "Terminal Count Near Zero Imports"

	Then I assign "BASE-PCK-0110" to variable "test_case"
...
@BASE-PCK-0110
Scenario Outline: BASE-PCK-0110 Terminal Count Near Zero
CSV Examples: Test Case Inputs/BASE-PCK-0110.csv
