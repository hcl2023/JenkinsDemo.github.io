...
############################################################ 
# Test Case: BASE-PCK-0070 Terminal Outbound Pallet Picking Undirected.feature
# 
...
#
# Input Source:Test Case Inputs/BASE-PCK-0070.csv
# Required Inputs:
...
#
############################################################
Feature: BASE-PCK-0070 Terminal Outbound Pallet Picking Undirected
...
Given I "setup the environment"
	...
	Then I assign "BASE-PCK-0070" to variable "test_case"
...
@BASE-PCK-0070
Scenario Outline: BASE-PCK-0070 Terminal Outbound Pallet Picking Undirected
CSV Examples: Test Case Inputs/BASE-PCK-0070.csv
...
Then I "Navigate to Pick Product Screen"
	...
	And I execute scenario "Navigate to Pick Product Screen"

When I execute scenario "Perform Undirected Pallet Pick for Order"
