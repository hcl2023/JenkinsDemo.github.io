...
############################################################ 
# Test Case: BASE-SHP-4030 Mobile Unload and Unpick Shipment.feature
#
...
#
# Description: This test case will unload a shipping trailer, and unpick the inventory that was picked for the shipment in the Mobile App
#
# Input Source: Test Case Inputs/BASE-SHP-4030.csv
# Required Inputs:
...
#
############################################################
Feature: BASE-SHP-4030 Mobile Unload and Unpick Shipment
...
Given I "setup the environment"
	...
	Given I execute scenario "Mobile Unloading Imports"

	Then I assign "BASE-SHP-4030" to variable "test_case"
...
@BASE-SHP-4030
Scenario Outline: BASE-SHP-4030 Mobile Unload and Unpick Shipment
CSV Examples: Test Case Inputs/BASE-SHP-4030.csv

Given I "execute pre-test scenario actions (including pre-validations)"
	And I execute scenario "Begin Pre-Test Activities"

Then I "log into Mobile App and navigate to the Unload Equipment menu"
	And I execute scenario "Mobile Login"
	And I execute scenario "Mobile Navigate to Unload Equipment Menu"
    
When I "Unload the equipment"
	Then I execute scenario "Mobile Outbound Unload and Unpick Shipment"
