...
############################################################ 
# Test Case: BASE-SHP-0010 Terminal Outbound Trailer Close.feature
#
...
#
# Input Source: Test Case Inputs/BASE-SHP-0010.csv
# Required Inputs:
...
#
############################################################
Feature: BASE-SHP-0010 Terminal Outbound Trailer Close
...
Given I "setup the environment"
	...
	Then I assign "BASE-SHP-0010" to variable "test_case"
...
@BASE-SHP-0010
Scenario Outline: BASE-SHP-0010 Terminal Outbound Trailer Close
CSV Examples: Test Case Inputs/BASE-SHP-0010.csv

Given I "execute pre-test scenario actions (including pre-validations)"
	And I execute scenario "Begin Pre-Test Activities"

Then I "log into terminal and navigate to the close equipment menu"
...
When I "perform trailer closing"
	Then I execute scenario "Terminal Outbound Trailer Close"
