...
############################################################ 
# Test Case: BASE-LDG-4020 Mobile Outbound Loading LTL Undirected.feature
#
...
#
# Input Source: Test Case Inputs/BASE-LDG-4020.csv
# Required Inputs:
...
#
############################################################
Feature: BASE-LDG-4020 Mobile Outbound Loading LTL Undirected
...
Given I "setup the environment"
	...
	Then I assign "BASE-LDG-4020" to variable "test_case"
...
@BASE-LDG-4020
Scenario Outline: BASE-LDG-4020 Mobile Outbound Loading LTL Undirected
CSV Examples: Test Case Inputs/BASE-LDG-4020.csv

Given I "execute pre-test scenario actions (including pre-validations)"
	And I execute scenario "Begin Pre-Test Activities"

Then I "login into the Mobile App and perform ltl loading of the trailer"
	And I execute scenario "Mobile Login"
	And I execute scenario "Mobile Navigate to LTL Load Menu"
	When  I execute scenario "Mobile Perform Undirected LTL Loading"
