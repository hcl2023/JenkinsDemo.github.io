...
############################################################ 
# Test Case: BASE-SHP-1130 Web Outbound Trailer Reopen.feature
#
...
#
# Input Source: Test Case Inputs/BASE-SHP-1130.csv
# Required Inputs: 
...
# 
############################################################ 
Feature: BASE-SHP-1130 Web Outbound Trailer Reopen
...
Given I "setup the environment"
	...
	Then I assign "BASE-SHP-1130" to variable "test_case"
...
@BASE-SHP-1130
Scenario Outline: BASE-SHP-1130 Web Outbound Trailer Reopen
CSV Examples: Test Case Inputs/BASE-SHP-1130.csv
...
And I "validate Web Trailer was closed"
	Then I execute scenario "Validate Trailer Closed"

And I "re-open the Trailer"
	Then I execute scenario "Web Reopen Transport Equipment"

And I "validate Web Trailer was re-opened"
