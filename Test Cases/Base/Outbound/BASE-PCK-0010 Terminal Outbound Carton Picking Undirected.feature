...
############################################################ 
# Test Case: BASE-PCK-0010 Terminal Outbound Carton Picking Undirected.feature
# 
...
#
# Input Source: Test Case Inputs/BASE-PCK-0010.csv
# Required Inputs:
...
#	Example Row: Carton Picking Undirected work with CRADLE_TO_GRAVE serialization
#	Example Row: Carton Picking Undirected work with OUTCAP_ONLY serialization
#	Example Row: Carton Picking Undirected work with no serialization
#
############################################################
Feature: BASE-PCK-0010 Terminal Outbound Carton Picking Undirected
...
Given I "setup the environment"
	...
	Then I assign "BASE-PCK-0010" to variable "test_case"
...
@BASE-PCK-0010
Scenario Outline: BASE-PCK-0010 Terminal Outbound Carton Picking Undirected
CSV Examples: Test Case Inputs/BASE-PCK-0010.csv

Given I "execute pre-test scenario actions (including pre-validations)"
	And I execute scenario "Begin Pre-Test Activities"

Then I "login to the terminal and navigate to the Carton Pick Menu"
	And I execute scenario "Terminal Login"
	And I execute scenario "Terminal Navigate to Carton Pick Menu"

When I execute scenario "Terminal Perform Carton Picks for Order"
