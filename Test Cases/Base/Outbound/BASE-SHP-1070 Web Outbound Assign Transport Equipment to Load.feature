...
############################################################ 
# Test Case: BASE-SHP-1070 Web Outbound Assign Transport Equipment to Load.feature
#
...
#
# Input Source: Test Case Inputs/BASE-SHP-1070.csv
# Required Inputs:
...
# 
############################################################ 
Feature: BASE-SHP-1070 Web Outbound Assign Transport Equipment to Load
...
Given I "setup the environment"
	...
	Then I assign "BASE-SHP-1070" to variable "test_case"
	When I execute scenario "Test Data Triggers"

And I "load the dataset"	
	Then I assign "Create_Outbound_Load_Trailer" to variable "dataset_directory"
...
And I "cleanup the dataset"
	Then I assign "Create_Outbound_Load_Trailer" to variable "cleanup_directory"
	And I execute scenario "Perform MOCA Cleanup Script"

@BASE-SHP-1070
Scenario Outline: BASE-SHP-1070 Web Outbound Assign Transport Equipment to Load
CSV Examples: Test Case Inputs/BASE-SHP-1070.csv
...
When I "Assign Transport Equipment to Load"
	Then I execute scenario "Web Outbound Assign Transport Equipment to Load"

Then I "Verify Transport Equipment Assigned to Load"
	And I execute scenario "Web Validate Transport Equipment Assigned to Load"
