...
############################################################ 
# Test Case: BASE-SHP-0020 Terminal Outbound Reopen Closed Transport Equipment.feature
#
...
#
# Input Source: Test Case Inputs/BASE-SHP-0020.csv
# Required Inputs:
...
#
############################################################
Feature: BASE-SHP-0020 Terminal Outbound Reopen Closed Transport Equipment
...
Given I "setup the environment"
	...
	Then I assign "BASE-SHP-0020" to variable "test_case"
...
@BASE-SHP-0020
Scenario Outline: BASE-SHP-0020 Terminal Outbound Reopen Closed Transport Equipment
CSV Examples: Test Case Inputs/BASE-SHP-0020.csv

Given I "execute pre-test scenario actions (including pre-validations)"
	And I execute scenario "Begin Pre-Test Activities"

Then I "log into terminal and navigate to the Reopen Equipment menu"
	And I execute scenario "Terminal Login"
	And I execute scenario "Terminal Navigate to Reopen Equipment Menu"
    
When I "reopen the closed transport equipment"
	Then I execute scenario "Terminal Outbound Trailer Reopen"
