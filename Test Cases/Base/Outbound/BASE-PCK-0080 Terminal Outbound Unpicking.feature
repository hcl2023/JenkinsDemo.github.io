...
############################################################ 
# Test Case: BASE-PCK-0080 Terminal Outbound Unpicking.feature
# 
...
#
# Description:
# This test case performs terminal Unpicking functions in the Terminal
# 
# Input Source: Test Case Inputs/BASE-PCK-0080.csv
# Required Inputs:
...
#	Example Row: Unpick Partial
#	Example Row: Unpick complete
# 
############################################################ 
Feature: BASE-PCK-0080 Terminal Outbound Unpicking
...
Given I "setup the environment"
	...
	Then I assign "BASE-PCK-0080" to variable "test_case"
...
@BASE-PCK-0080
Scenario Outline: BASE-PCK-0080 Terminal Outbound Unpicking
CSV Examples: Test Case Inputs/BASE-PCK-0080.csv

Given I "execute pre-test scenario actions (including pre-validations)"
	And I execute scenario "Begin Pre-Test Activities"

Then I "login to the terminal and navigate to the Unpick Menu"
	And I execute scenario "Terminal Login"
    And I execute scenario "Terminal Navigate to Unpick Menu"

When I execute scenario "Terminal Perform Unpick"
