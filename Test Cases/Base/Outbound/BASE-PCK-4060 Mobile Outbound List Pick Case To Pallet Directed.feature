...
############################################################ 
# Test Case: BASE-PCK-4060 Mobile Outbound List Pick Case To Pallet Directed.feature
# 
...
#
# Description: This Test Case performs Mobile App Directed List Pick Case To Pallet
#
# Input Source:Test Case Inputs/BASE-PCK-4060.csv
# Required Inputs:
...
#	Example Row: List Pick Case To Pallet Direct work with CRADLE_TO_GRAVE serialization
#	Example Row: List Pick Case To Pallet Direct work with OUTCAP_ONLY serialization
#	Example Row: List Pick Case To Pallet Direct work with no serialization
#
############################################################
Feature: BASE-PCK-4060 Mobile Outbound List Pick Case To Pallet Directed
...
Given I "setup the environment"
	...
	Then I assign "BASE-PCK-4060" to variable "test_case"
...
@BASE-PCK-4060
Scenario Outline: BASE-PCK-4060 Mobile Outbound List Pick Case To Pallet Directed
CSV Examples:Test Case Inputs/BASE-PCK-4060.csv

Given I "execute pre-test scenario actions (including pre-validations)"
	And I execute scenario "Begin Pre-Test Activities"

Then I "login to the Mobile App, assign work, and traverse to directed work menu"
	And I "wait for work to release" which can take between $wait_med seconds and $wait_long seconds
