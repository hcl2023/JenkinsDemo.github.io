...
############################################################ 
# Test Case: BASE-LDG-0030 Terminal Outbound Loading TL Directed.feature
#
...
#
# Input Source: Test Case Inputs/BASE-LDG-0030.csv
# Required Inputs:
...
#
############################################################
Feature: BASE-LDG-0030 Terminal Outbound Loading TL Directed
...
Given I "setup the environment"
	...
	Then I assign "BASE-LDG-0030" to variable "test_case"
...
@BASE-LDG-0030
Scenario Outline: BASE-LDG-0030 Terminal Outbound Loading TL Directed
CSV Examples: Test Case Inputs/BASE-LDG-0030.csv
...
When I "perform directed TL loading operation"
  	And I execute scenario "Terminal Perform TL Directed Loading of All LPNs for Truck"
