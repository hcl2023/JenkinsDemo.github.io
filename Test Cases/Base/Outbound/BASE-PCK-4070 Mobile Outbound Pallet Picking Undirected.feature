...
############################################################ 
# Test Case: BASE-PCK-4070 Mobile Outbound Pallet Picking Undirected.feature
# 
...
#
# Input Source:Test Case Inputs/BASE-PCK-4070.csv
# Required Inputs:
...
#
############################################################
Feature: BASE-PCK-4070 Mobile Outbound Pallet Picking Undirected
...
Given I "setup the environment"
	...
	Then I assign "BASE-PCK-4070" to variable "test_case"
...
@BASE-PCK-4070
Scenario Outline: BASE-PCK-4070 Mobile Outbound Pallet Picking Undirected
CSV Examples: Test Case Inputs/BASE-PCK-4070.csv

Given I "execute pre-test scenario actions (including pre-validations)"
	And I execute scenario "Begin Pre-Test Activities"
   
Then I "navigate to Pick Product Screen"
	And I execute scenario "Mobile Login"
	And I execute scenario "Mobile Navigate to Pick Product Screen"

When I execute scenario "Mobile Perform Undirected Pallet Pick for Order"
