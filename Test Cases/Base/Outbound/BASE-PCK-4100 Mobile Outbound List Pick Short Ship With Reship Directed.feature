...
############################################################ 
# Test Case: BASE-PCK-4100 Mobile Outbound List Pick Short Ship With Reship Directed.feature
# 
...
#
# Input Source:Test Case Inputs/BASE-PCK-4100.csv
# Required Inputs:
...
#
############################################################
Feature: BASE-PCK-4100 Mobile Outbound List Pick Short Ship With Reship Directed
...
Given I "setup the environment"
	...
	And I execute scenario "Mobile Loading Imports"

	Then I assign "BASE-PCK-4100" to variable "test_case"
...
@BASE-PCK-4100
Scenario Outline: BASE-PCK-4100 Mobile Outbound List Pick Short Ship With Reship Directed
CSV Examples:Test Case Inputs/BASE-PCK-4100.csv
...
And I "load, close, and dispatch trailer"
	And I execute scenario "Mobile Navigate Quickly to Undirected Menu"
	And I execute scenario "Mobile Navigate to Load Equipment Menu"
	When I execute scenario "Mobile Perform Undirected TL Loading"
	...
	And I execute scenario "Mobile Outbound Trailer Close"

	Then I execute scenario "Mobile Navigate Quickly to Undirected Menu"
	And I execute scenario "Mobile Navigate to Dispatch Equipment Menu"
	And I execute scenario "Mobile Outbound Trailer Dispatch"
...
And I "get the local data variables for performing second pick"
	...
	And I execute scenario "Load Detail CSV Variables"
	Then I assign "Yes" to variable "ignore_cleanup"
...
When I "perform list pick for reship"
	And I execute scenario "Assign Work to User by Order and Operation"	
    And I execute scenario "Mobile Navigate to Directed Work Menu"
	Then I execute scenario "Mobile Perform Directed List Pick for Order"
...
# Inputs:
# 	Required:
#		detail_file_name - csv file that needs to be assigned as variables
...
#		bckflg - the back flg
#		pck_dstloc - the picking destination
# 	Optional:
#		None
# Outputs:
# 	None
