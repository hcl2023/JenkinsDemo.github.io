...
############################################################ 
# Test Case: BASE-PCK-0050 Terminal Outbound List Pick Case To Pallet Directed Cancel and Reallocate.feature
# 
...
#
# Input Source:Test Case Inputs/BASE-PCK-0050.csv
# Required Inputs:
...
#
############################################################
Feature: BASE-PCK-0050 Terminal Outbound List Pick Case To Pallet Directed Cancel and Reallocate
...
Given I "setup the environment"
	...
	Then I assign "BASE-PCK-0050" to variable "test_case"
...
@BASE-PCK-0050
Scenario Outline: BASE-PCK-0050 Terminal Outbound List Pick Case To Pallet Directed Cancel and Reallocate
CSV Examples:Test Case Inputs/BASE-PCK-0050.csv
...
When I "perform directed list pick to pallet cancel and reallocate"
