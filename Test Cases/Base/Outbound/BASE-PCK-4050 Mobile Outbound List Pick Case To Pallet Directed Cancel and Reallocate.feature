...
############################################################ 
# Test Case: BASE-PCK-4050 Mobile Outbound List Pick Case To Pallet Directed Cancel and Reallocate.feature
# 
...
#
# Description: This Test Case performs Mobile App Outbound List Pick Case To Pallet Directed Cancel and Reallocate
#
# Input Source:Test Case Inputs/BASE-PCK-4050.csv
# Required Inputs:
...
CSV Examples:Test Case Inputs/BASE-PCK-4050.csv
