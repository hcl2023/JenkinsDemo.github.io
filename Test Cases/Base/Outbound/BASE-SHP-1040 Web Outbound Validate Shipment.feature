...
############################################################ 
# Test Case: BASE-SHP-1040 Web Outbound Validate Shipment.feature
#
...
#
# Input Source: Test Case Inputs/BASE-SHP-1040.csv
# Required Inputs:
...
# 
############################################################ 
Feature: BASE-SHP-1040 Web Outbound Validate Shipment
...
Given I "setup the environment"
	...
	Then I assign "BASE-SHP-1040" to variable "test_case"
...
@BASE-SHP-1040
Scenario Outline: BASE-SHP-1040 Web Outbound Validate Shipment
CSV Examples: Test Case Inputs/BASE-SHP-1040.csv
...
When I "validate the incoming shipment and screen/system information about the shipment"
	Then I execute scenario "Web Validate Shipment"
	And I execute scenario "Web Validate Shipment Info"
