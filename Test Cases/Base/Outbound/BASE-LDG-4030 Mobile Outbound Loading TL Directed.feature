...
############################################################ 
# Test Case: BASE-LDG-4030 Mobile Outbound Loading TL Directed.feature
#
...
#
# Input Source: Test Case Inputs/BASE-LDG-4030.csv
# Required Inputs:
...
#
############################################################
Feature: BASE-LDG-4030 Mobile Outbound Loading TL Directed
...
Given I "setup the environment"
	...
	Then I assign "BASE-LDG-4030" to variable "test_case"
...
And I "load the dataset"
	...
	EndIf
	And I assign "PPK" to variable "oprcod"
...
@BASE-LDG-4030
Scenario Outline: BASE-LDG-4030 Mobile Outbound Loading TL Directed
CSV Examples: Test Case Inputs/BASE-LDG-4030.csv
...
When I "perform directed TL loading operation"
  	And I execute scenario "Mobile Perform TL Directed Loading of All LPNs for Truck"
