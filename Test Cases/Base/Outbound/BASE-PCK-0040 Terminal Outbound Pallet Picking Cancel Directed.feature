...
############################################################ 
# Test Case: BASE-PCK-0040 Terminal Outbound Pallet Picking Cancel Directed.feature
# 
...
#
# Input Source: Test Case Inputs/BASE-PCK-0040.csv
# Required Inputs:
...
#
############################################################
Feature: BASE-PCK-0040 Terminal Outbound Pallet Picking Cancel Directed
...
Given I "setup the environment"
	...
	Then I assign "BASE-PCK-0040" to variable "test_case"
...
@BASE-PCK-0040
Scenario Outline: BASE-PCK-0040 Terminal Outbound Pallet Picking Cancel Directed
CSV Examples: Test Case Inputs/BASE-PCK-0040.csv

Given I "execute pre-test scenario actions (including pre-validations)"
	And I execute scenario "Begin Pre-Test Activities"
   
Then I "login to the terminal and navigate to the Directed Work Menu"
