...
############################################################ 
# Test Case: BASE-RPL-4010 Mobile Outbound Pallet Replenishment.feature
# 
...
#
# Description: This test case performs a pallet replenishment in the Mobile App
#
...
# None
############################################################ 
Feature: BASE-RPL-4010 Mobile Outbound Pallet Replenishment
...
Given I "setup the environment"
	...
	Then I assign "BASE-RPL-4010" to variable "test_case"
...
@BASE-RPL-4010
Scenario Outline: BASE-RPL-4010 Mobile Outbound Pallet Replenishment
CSV Examples: Test Case Inputs/BASE-RPL-4010.csv
