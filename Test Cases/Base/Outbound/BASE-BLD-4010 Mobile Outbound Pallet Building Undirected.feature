...
############################################################
# Test Case: BASE-BLD-4010 Mobile Outbound Pallet Building Undirected.feature
# 
...
#
# Description: This Test Case performs Mobile App undirected pallet building
#
# Input Source: Datasets/Test Case Inputs/BASE-PCK-4010.csv
# Required Inputs:
...
#
############################################################
Feature: BASE-BLD-4010 Mobile Outbound Pallet Building Undirected
...
Given I "setup the environment"
	...
	Given I execute scenario "Mobile Pallet Building Imports"

	Then I assign "BASE-BLD-4010" to variable "test_case"
	When I execute scenario "Test Data Triggers"

    If I verify variable "mobile_devcod" is assigned
		Then I assign value $mobile_devcod to unassigned variable "pb_stage_loc"
		And I assign $mobile_devcod to variable "devcod"
	Else I assign value $devcod to unassigned variable "pb_stage_loc"
	EndIf
...
@BASE-BLD-4010
Scenario Outline: BASE-BLD-4010 Mobile Outbound Pallet Building Undirected
CSV Examples: Test Case Inputs/BASE-BLD-4010.csv

Given I "execute pre-test scenario actions (including pre-validations)"
	And I execute scenario "Begin Pre-Test Activities"

Then I execute scenario "Mobile Login"
And I execute scenario "Mobile Open Pallet Building Menu Option"
When I execute scenario "Mobile Pallet Building"
