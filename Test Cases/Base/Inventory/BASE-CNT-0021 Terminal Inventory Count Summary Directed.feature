...
############################################################ 
# Test Case: BASE-CNT-0021 Terminal Inventory Count Summary Directed.feature
#
...
#
# Description: This test case performs a cycle summary count on the terminal in Directed work mode.
#
# Input Source: Test Case Inputs/BASE-CNT-0021.csv
# Required Inputs:
...
# 
# Assumptions:
# - For Directed work, the user and terminal need to be setup to do count work. And there should be no
...
#
############################################################ 
Feature: BASE-CNT-0021 Terminal Inventory Count Summary Directed
...
Given I "setup the environment"
	...
	Then I assign "BASE-CNT-0021" to variable "test_case"
...
@BASE-CNT-0021
Scenario Outline: BASE-CNT-0021 Terminal Inventory Count Summary Directed
CSV Examples: Test Case Inputs/BASE-CNT-0021.csv
...
When I "prcocess the Summary Count"
    ...
    And I execute scenario "Terminal Inventory Perform Summary Count"
