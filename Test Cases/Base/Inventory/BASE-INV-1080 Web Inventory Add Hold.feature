...
############################################################ 
# Test Case: BASE-INV-1080 Web Inventory Add Hold.feature
#
...
#
# Input Source: Test Case Inputs/BASE-INV-1080.csv
# Required Inputs:
...
#
############################################################ 
Feature: BASE-INV-1080 Web Inventory Add Hold
...
Given I "setup the environment"
	...
	And I assign "BASE-INV-1080" to variable "test_case"
	When I execute scenario "Test Data Triggers"

And I "load the dataset"	
	Then I assign "Inv_Add_Hold" to variable "dataset_directory"
...
And I "cleanup the dataset"
	Then I assign "Inv_Add_Hold" to variable "cleanup_directory"
	And I execute scenario "Perform MOCA Cleanup Script"

@BASE-INV-1080
Scenario Outline: BASE-INV-1080 Web Inventory Add Hold
CSV Examples: Test Case Inputs/BASE-INV-1080.csv
