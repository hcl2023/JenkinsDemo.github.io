...
############################################################ 
# Test Case: BASE-CNT-4042 Mobile Inventory Audit Count Add LPN Directed.feature
#
...
#
# Description: This test case performs a audit count adding a new LPN not originally in the location in the Mobile App
#
# Input Source: Test Case Inputs/BASE-CNT-4042.csv
# Required Inputs:
...
#
############################################################ 
Feature: BASE-CNT-4042 Mobile Inventory Audit Count Add LPN Directed
...
Given I "setup the environment"
	...
	Then I assign "BASE-CNT-4042" to variable "test_case"
...
@BASE-CNT-4042
Scenario Outline: BASE-CNT-4042 Mobile Inventory Audit Count Add LPN Directed
CSV Examples: Test Case Inputs/BASE-CNT-4042.csv
...
When I "perform and verify the audit count"
	...
	And I execute scenario "Mobile Inventory Audit Count Add LPN"
