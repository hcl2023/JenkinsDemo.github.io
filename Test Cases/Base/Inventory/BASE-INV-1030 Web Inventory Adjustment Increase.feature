...
############################################################ 
# Test Case: BASE-INV-1030 Web Inventory Adjustment Increase.feature
#
...
#
# Description:
# This test case will handle using the Web to complete an inventory adjustment to increase existing inventory
# and confirm the inventory has been adjusted into the system. If adjustment approvals are enabled and the 
# adjustment exceeds the threshold, this test case will acknowledge approval if required and confirm the inventory
# adjustment is pending approval.
#
# Input Source: Test Case Inputs/BASE-INV-1030.csv
# Required Inputs:
...
#
############################################################ 
Feature: BASE-INV-1030 Web Inventory Adjustment Increase
...
Given I "setup the environment"
	...
	And I assign "BASE-INV-1030" to variable "test_case"
...
@BASE-INV-1030
Scenario Outline: BASE-INV-1030 Web Inventory Adjustment Increase
CSV Examples: Test Case Inputs/BASE-INV-1030.csv
