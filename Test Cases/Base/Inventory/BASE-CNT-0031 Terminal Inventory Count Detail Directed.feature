...
############################################################ 
# Test Case: BASE-CNT-0031 Terminal Inventory Count Detail Directed.feature
#
...
#
# Description: This test case performs a Directed detail count in the terminal. The screen flow is
# almost identical to an Audit Count, but the detail count does not adjust inventory
#
# Input Source: Test Case Inputs/BASE-CNT-0031.csv
# Required Inputs:
...
# 
# Assumptions:  
# - For Directed work, the user and terminal need to be setup to do detail count work. And there should be no
...
#
############################################################ 
Feature: BASE-CNT-0031 Terminal Inventory Count Detail Directed
...
Given I "setup the environment"
	...
	Then I assign "BASE-CNT-0031" to variable "test_case"
...
@BASE-CNT-0031
Scenario Outline: BASE-CNT-0031 Terminal Inventory Count Detail Directed
CSV Examples: Test Case Inputs/BASE-CNT-0031.csv
