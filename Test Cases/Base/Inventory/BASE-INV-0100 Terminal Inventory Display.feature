...
############################################################ 
# Test Case: BASE-INV-0100 Terminal Inventory Display.feature
# 
...
#
# Description: This Test Case will perform an inventory display given a lodnum and prtnum in the terminal
#
# Input Source: Test Case Inputs/BASE-INV-0100.csv
# Required Inputs:
...
#
############################################################
Feature: BASE-INV-0100 Terminal Inventory Display
...
Given I "setup the environment"
	...
	Then I assign "BASE-INV-0100" to variable "test_case"
...
@BASE-INV-0100
Scenario Outline: BASE-INV-0100 Terminal Inventory Display
CSV Examples: Test Case Inputs/BASE-INV-0100.csv
...
Then I "log into the terminal and navigate to the inventory display screen"
	...
	And I execute scenario "Terminal Inventory Display Menu"

When I "perform an inventory display from the terminal"
	And I execute scenario "Terminal Inventory Display"
