...
############################################################ 
# Test Case: BASE-INV-0080 Terminal Inbound Directed Putaway from Inventory Override.feature
# 
...
#
# Input Source: Test Case Inputs/BASE-INV-0080.csv
# Required Inputs:
# 	wh_id - Warehouse ID
...
#
############################################################
Feature: BASE-INV-0080 Terminal Inbound Directed Putaway from Inventory Override
...
Given I "setup the environment"
	...
	Given I execute scenario "Inventory Inbound Putaway Imports"

	Then I assign "BASE-INV-0080" to variable "test_case"
...
@BASE-INV-0080
Scenario Outline: BASE-INV-0080 Terminal Inbound Directed Putaway from Inventory Override
CSV Examples: Test Case Inputs/BASE-INV-0080.csv
...
When I "Perform the Putaway Directed with override (F4)"
	Then I execute scenario "Terminal Putaway Menu"
	And I execute scenario "Terminal Inventory Putaway Directed Override"
