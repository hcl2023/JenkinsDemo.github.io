...
############################################################ 
# Test Case: BASE-CNT-4010 Mobile Inventory Count LPN Undirected.feature
# 
...
#
# Description: This test case performs an LPN count on Mobile for undirected work.
#
# Input Source: Test Case Inputs/BASE-CNT-4010.csv
# Required Inputs:
...
#
############################################################ 
Feature: BASE-CNT-4010 Mobile Inventory Count LPN Undirected
...
Given I "setup the environment"
	...
	Then I assign "BASE-CNT-4010" to variable "test_case"
...
@BASE-CNT-4010
Scenario Outline: BASE-CNT-4010 Mobile Inventory Count LPN Undirected
CSV Examples: Test Case Inputs/BASE-CNT-4010.csv
