...
############################################################ 
# Test Case: BASE-INV-4060 Mobile Inventory Transfer Undirected.feature
# 
...
#
# Description: This test case performs a full inventory move as Undirected work in the Mobile App
#
# Input Source: Test Case Inputs/BASE-INV-4060.csv
# Required Inputs:
...
#
############################################################ 
Feature: BASE-INV-4060 Mobile Inventory Transfer Undirected
...
Given I "setup the environment"
	...
	Then I assign "BASE-INV-4060" to variable "test_case"
...
@BASE-INV-4060
Scenario Outline: BASE-INV-4060 Mobile Inventory Transfer Undirected
CSV Examples: Test Case Inputs/BASE-INV-4060.csv
