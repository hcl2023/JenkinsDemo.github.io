...
############################################################ 
# Test Case: BASE-INV-0020 Terminal Inventory Adjustment Delete.feature
#
...
#
# Description: This test case deletes a single load of inventory on the terminal
#
# Input Source: Test Case Inputs/BASE-INV-0020.csv
# Required Inputs:
...
#
############################################################ 
Feature: BASE-INV-0020 Terminal Inventory Adjustment Delete
...
Given I "setup the environment"
	...
	Then I assign "BASE-INV-0020" to variable "test_case"
...
@BASE-INV-0020
Scenario Outline: BASE-INV-0020 Terminal Inventory Adjustment Delete
CSV Examples: Test Case Inputs/BASE-INV-0020.csv

Given I "execute pre-test scenario actions (including pre-validations)"
	And I execute scenario "Begin Pre-Test Activities"

And I "login to the terminal"
...
When I "navigate to the adjustment screen and perform the adjustment"
	...
	And I execute scenario "Terminal Inventory Adjustment Delete"
