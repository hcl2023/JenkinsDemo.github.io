...
############################################################ 
# Test Case: BASE-INV-0140 Terminal Inventory Transfer Multiple LPNs Undirected.feature
# 
...
#
# Description: This test case performs a full inventory move of multiple LPNs as Undirected work in the Terminal
#
# Input Source: Test Case Inputs/BASE-INV-0140.csv
# Required Inputs:
...
#
############################################################ 
Feature: BASE-INV-0140 Terminal Inventory Transfer Multiple LPNs Undirected
...
Given I "setup the environment"
	...
	Then I assign "BASE-INV-0140" to variable "test_case"
...
@BASE-INV-0140
Scenario Outline: BASE-INV-0140 Terminal Inventory Transfer Multiple LPNs Undirected
CSV Examples: Test Case Inputs/BASE-INV-0140.csv
