...
############################################################ 
# Test Case: BASE-CNT-0010 Terminal Inventory Count LPN Undirected.feature
# 
...
#
# Description: This test case performs an LPN count on Terminal for undirected work.
#
# Input Source: Test Case Inputs/BASE-CNT-0010.csv
# Required Inputs:
...
#
############################################################ 
Feature: BASE-CNT-0010 Terminal Inventory Count LPN Undirected
...
Given I "setup the environment"
	...
	Then I assign "BASE-CNT-0010" to variable "test_case"
...
@BASE-CNT-0010
Scenario Outline: BASE-CNT-0010 Terminal Inventory Count LPN Undirected
CSV Examples: Test Case Inputs/BASE-CNT-0010.csv
