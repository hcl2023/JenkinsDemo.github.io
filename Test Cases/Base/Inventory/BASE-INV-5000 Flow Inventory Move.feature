...
############################################################ 
# Test Case: BASE-INV-5000 Flow Inventory Move.feature
#
...
# destination location as directed work, perform the inventory movement on the terminal, and confirm the inventory has been moved to the destination location.
#
# Input Source: Test Case Inputs/BASE-INV-5000.csv
# Required Inputs:
...
#
############################################################ 
Feature: BASE-INV-5000 Flow Inventory Move
...
Given I "setup the environment"
	...
	And I assign "BASE-INV-5000" to variable "test_case"
...
@BASE-INV-5000
Scenario Outline: BASE-INV-5000 Flow Inventory Move
CSV Examples: Test Case Inputs/BASE-INV-5000.csv
...
Then I "perform directed inventory transfer on Terminal"  
	Given I execute scenario "Terminal Login"
