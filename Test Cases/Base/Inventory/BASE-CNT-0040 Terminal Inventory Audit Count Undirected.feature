...
############################################################ 
# Test Case: BASE-CNT-0040 Terminal Inventory Audit Count Undirected.feature
#
...
#
# Input Source: Test Case Inputs/BASE-CNT-0040.csv
# Required Inputs:
...
#
############################################################ 
Feature: BASE-CNT-0040 Terminal Inventory Audit Count Undirected
...
Given I "setup the environment"
	...
	Then I assign "BASE-CNT-0040" to variable "test_case"
...
@BASE-CNT-0040
Scenario Outline: BASE-CNT-0040 Terminal Inventory Audit Count Undirected
CSV Examples: Test Case Inputs/BASE-CNT-0040.csv
...
Then I "log into the Terminal and navigate to audit count screen"
    ...
    And I execute scenario "Terminal Navigate to Audit Count Menu"

When I "perform an Audit Count"
	Then I execute scenario "Terminal Inventory Audit Count Enter Batch and Location Undirected Work"
