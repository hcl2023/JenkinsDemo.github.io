...
############################################################ 
# Test Case: BASE-INV-4030 Mobile Inventory Adjustment Increase.feature
# 
...
#
# Description: This test case adds additional quantity to an existing load in a location on the Mobile App
#
# Input Source: Test Case Inputs/BASE-INV-4030.csv
# Required Inputs:
...
#
############################################################ 
Feature: BASE-INV-4030 Mobile Inventory Adjustment Increase
...
Given I "setup the environment"
	...
	Then I assign "BASE-INV-4030" to variable "test_case"
...
@BASE-INV-4030
Scenario Outline: BASE-INV-4030 Mobile Inventory Adjustment Increase
CSV Examples: Test Case Inputs/BASE-INV-4030.csv
...
When I "navigate to the adjustment menu and perform the adjustment"
