...
############################################################ 
# Test Case: BASE-CNT-0011 Terminal Inventory Count LPN Directed.feature
# 
...
#
# Description: This test case performs an LPN count on Terminal for Directed work.
#
# Input Source: Test Case Inputs/BASE-CNT-0011.csv
# Required Inputs:
...
#	does not allow for LPN counting (eg. ABC Cycle Count), the Terminal still goes into LPN counting screens but errors at
...
# - For Directed work, the user and terminal need to be setup to do cycle count work. And there should be no
...
#
############################################################ 
Feature: BASE-CNT-0011 Terminal Inventory Count LPN Directed
...
Given I "setup the environment"
	...
	Then I assign "BASE-CNT-0011" to variable "test_case"
...
@BASE-CNT-0011
Scenario Outline: BASE-CNT-0011 Terminal Inventory Count LPN Directed
CSV Examples: Test Case Inputs/BASE-CNT-0011.csv
...
When I "prcocess the LPN Count"
	Then I execute scenario "Terminal Inventory Count Process Directed Work Screen"
    And I execute scenario "Terminal Inventory Perform LPN Count"
