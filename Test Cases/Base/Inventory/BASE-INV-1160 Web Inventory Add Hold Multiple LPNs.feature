...
############################################################ 
# Test Case: BASE-INV-1160 Web Inventory Add Hold Multiple LPNs.feature
#
...
#
# Description: This test case will add a hold to multiple pieces of inventory from the Web
#
# Input Source: Test Case Inputs/BASE-INV-1160.csv
# Required Inputs:
...
#
############################################################ 
Feature: BASE-INV-1160 Web Inventory Add Hold Multiple LPNs
...
Given I "setup the environment"
	...
	And I assign "BASE-INV-1160" to variable "test_case"
...
@BASE-INV-1160
Scenario Outline: BASE-INV-1160 Web Inventory Add Hold Multiple LPNs
CSV Examples: Test Case Inputs/BASE-INV-1160.csv
