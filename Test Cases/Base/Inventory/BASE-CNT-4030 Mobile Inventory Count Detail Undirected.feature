...
############################################################ 
# Test Case: BASE-CNT-4030 Mobile Inventory Count Detail Undirected.feature
#
...
#
# Description: This test case performs a Undirected detail count in the Mobile App. The screen flow is
# almost identical to an Audit Count, but the detail count does not adjust inventory
#
# Input Source: Test Case Inputs/BASE-CNT-4030.csv
# Required Inputs:
...
#
############################################################ 
Feature: BASE-CNT-4030 Mobile Inventory Count Detail Undirected
...
Given I "setup the environment"
	...
	Then I assign "BASE-CNT-4030" to variable "test_case"
...
@BASE-CNT-4030
Scenario Outline: BASE-CNT-4030 Mobile Inventory Count Detail Undirected
CSV Examples: Test Case Inputs/BASE-CNT-4030.csv
...
And I "navigate to the undirected count screen"
    Then I execute scenario "Mobile Navigate to Cycle Count Menu"
    
When I "prcocess the Detail Count"
	Then I execute scenario "Mobile Inventory Count Enter Batch and Location Undirected Work"
    And I execute scenario "Mobile Inventory Perform Detail Count"
    And I execute scenario "Mobile Inventory Count Complete Undirected Work"
