...
############################################################ 
# Test Case: BASE-CNT-4050 Mobile Inventory Count Manual Undirected.feature
# 
...
#
# Description: This test case performs a manual count in the Mobile App.
#
# Input Source: Test Case Inputs/BASE-CNT-4050.csv
# Required Inputs:
...
#
############################################################ 
Feature: BASE-CNT-4050 Mobile Inventory Count Manual Undirected
...
Given I "setup the environment"
	...
	Then I assign "BASE-CNT-4050" to variable "test_case"
...
@BASE-CNT-4050
Scenario Outline: BASE-CNT-4050 Mobile Inventory Count Manual Undirected
CSV Examples: Test Case Inputs/BASE-CNT-4050.csv
...
And I "navigate to the manual count screen"
    Then I execute scenario "Mobile Navigate to Manual Count Menu"
    
When I "select the LPN or location I want to manually count and proceed with the count"
	Then I execute scenario "Mobile Manual Count Process"
