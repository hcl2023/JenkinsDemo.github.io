...
############################################################ 
# Test Case: BASE-INV-4120 Mobile Inventory Partial Move.feature
#
...
#
# Description: This test case will perform a Mobile inventory move of a partial quantity in a load, verify that the move was successful.
#
# Input Source: Test Case Inputs/BASE-INV-4120.csv
# Required Inputs:
...
# 	dstloc - The destination location of the LPN to be moved. Must be a valid adjustable/storable location in the system. Must be a different location than the source location. Used in Mobile App interactions and post move validation.
...
#	prtnum - This needs to be a valid part number that is defined in your system. The part will use the default client_id defined in Environment.feature. Used in load dataset processing and Mobile App validation.
...
#
############################################################ 
Feature: BASE-INV-4120 Mobile Inventory Partial Move
...
Given I "setup the environment"
	...
	And I assign "BASE-INV-4120" to variable "test_case"
...
@BASE-INV-4120
Scenario Outline: BASE-INV-4120 Mobile Inventory Partial Move
CSV Examples: Test Case Inputs/BASE-INV-4120.csv
...
Then I "log into the Mobile App and navigate to audit count screen"
	...
	And I execute scenario "Mobile Navigate to Partial Inventory Move Menu"

When I "perform and validate the partial inventory move"
	Then I execute scenario "Mobile Partial Inventory Move"
