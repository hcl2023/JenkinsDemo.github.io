...
############################################################ 
# Test Case: BASE-INV-4150 Mobile Inventory Partial Move Multiple LPNs.feature
#
...
#
# Description: This test case will perform a Mobile inventory move of a partial quantity in a load for multiple LPNs, and verify that the moves were successful.
#
# Input Source: Test Case Inputs/BASE-INV-4150.csv
# Required Inputs:
...
#
############################################################ 
Feature: BASE-INV-4150 Mobile Inventory Partial Move Multiple LPNs
...
Given I "setup the environment"
	...
	And I assign "BASE-INV-4150" to variable "test_case"
...
@BASE-INV-4150
Scenario Outline: BASE-INV-4150 Mobile Inventory Partial Move Multiple LPNs
CSV Examples: Test Case Inputs/BASE-INV-4150.csv

Given I "execute pre-test scenario actions (including pre-validations)"
	And I execute scenario "Begin Pre-Test Activities"

Then I "log into the Mobile App and navigate to partial inventory move screen"
