...
############################################################ 
# Test Case: BASE-YRD-0010 Terminal Trailer Move.feature
# 
...
#
# Input Source: Test Case Inputs/BASE-YRD-0010.csv
# Required Inputs:
# 	wh_id - Warehouse ID
...
#
############################################################
Feature: BASE-YRD-0010 Terminal Trailer Move
...
Given I "setup the environment"
	...
	Then I assign "BASE-YRD-0010" to variable "test_case"
...
@BASE-YRD-0010
Scenario Outline: BASE-YRD-0010 Terminal Trailer Move
CSV Examples: Test Case Inputs/BASE-YRD-0010.csv
...
Then I "setup for a trailer move operation"
	...
	And I execute scenario "Terminal Verify and Escalate Directed Work"

When I "execute a trailer move operation"
	Then I execute scenario "Terminal Login"
	And I execute scenario "Terminal Trailer Moving"
