...
############################################################ 
# Test Case: BASE-YRD-6000 Flow Mobile Yard Audit.feature
# 
...
#
# Input Source: Test Case Inputs/BASE-YRD-6000.csv
# Required Inputs:
...
#
############################################################
Feature: BASE-YRD-6000 Flow Mobile Yard Audit
...
Given I "setup the environment"
	...
	Then I execute scenario "Mobile Yard Audit Imports"
	And I execute scenario "Web Yard Audit Imports"
	And I execute scenario "Web Environment Setup" 

	Then I assign "BASE-YRD-6000" to variable "test_case"
...
@BASE-YRD-6000
Scenario Outline: BASE-YRD-6000 Flow Mobile Yard Audit
CSV Examples: Test Case Inputs/BASE-YRD-6000.csv
...
And I "open Receiving work queue screen, assign user to work queue and logout of the web"    
	...
	If I verify text $yard_audit_type is equal to "without_trailer" ignoring case
    	Then I "assign work for starting and ending location audits to user"
			...
			Then I execute scenario "Web Assign User to Work Queue"
			And I wait $wait_med seconds
			Then I assign $audit_start_loc to variable "yard_loc"
...
And I "open Mobile App and navigate to the directed work screen"
...
And I "check for directed work and process Yard Audit"
	Then I execute scenario "Mobile Yard Audit"
...
And I "verify Audit missing equipment is present in Web and perform Audit with missing trailer"
	If I verify text $yard_audit_type is equal to "without_trailer" ignoring case
		...
		Then I execute scenario "Mobile Login"
		And I execute scenario "Mobile Navigate to Directed Work Menu"
		And I execute scenario "Mobile Yard Audit With Missing Trailer"
	EndIf
