...
############################################################ 
# Test Case: BASE-YRD-1050 Web Outbound Trailer Check In with Safety Check.feature
# 
...
# Web Check In screen to check the outbound trailer into an available dock door then processes the safety checks
# 
# Input Source: Test Case Inputs/BASE-YRD-1050.csv
# Required Inputs:
...
# 
############################################################ 
Feature: BASE-YRD-1050 Web Outbound Trailer Check In with Safety Check
...
Given I "setup the environment"
	...
	And I assign "BASE-YRD-1050" to variable "test_case"
...
@BASE-YRD-1050
Scenario Outline: BASE-YRD-1050 Web Outbound Trailer Check In with Safety Check
CSV Examples: Test Case Inputs/BASE-YRD-1050.csv
...
And I execute scenario "Web Process Outbound Trailer Safety Check"
