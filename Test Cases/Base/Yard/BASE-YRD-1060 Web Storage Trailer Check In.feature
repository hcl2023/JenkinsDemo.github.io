...
############################################################ 
# Test Case: BASE-YRD-1060 Web Storage Trailer Check In.feature
# 
...
#
# Input Source: Test Case Inputs/BASE-YRD-1060.csv
# Required Inputs:
...
#
############################################################
Feature: BASE-YRD-1060 Web Storage Trailer Check In
...
Given I "setup the environment"
	...
	Then I assign "BASE-YRD-1060" to variable "test_case"
	When I execute scenario "Test Data Triggers"

And I "load the dataset"	
	Then I assign "YRD_Trailer_Checkin" to variable "dataset_directory"
...
And I "cleanup the dataset"
	Then I assign "YRD_Trailer_Checkin" to variable "cleanup_directory"
	And I execute scenario "Perform MOCA Cleanup Script"

@BASE-YRD-1060
Scenario Outline: BASE-YRD-1060 Web Storage Trailer Check In
CSV Examples: Test Case Inputs/BASE-YRD-1060.csv

Given I "execute pre-test scenario actions (including pre-validations)"
	And I execute scenario "Begin Pre-Test Activities"

Then I execute scenario "Web Login"
And I execute scenario "Web Open Yard Check In Screen"
And I execute scenario "Web Open Add Transport Equipment Screen"
And I execute scenario "Web Add Storage Transport Equipment Infomation"
And I execute scenario "Web Check In Storage Trailer"
