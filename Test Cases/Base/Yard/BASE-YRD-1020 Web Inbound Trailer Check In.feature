...
############################################################ 
# Test Case: BASE-YRD-1020 Web Inbound Trailer Check In.feature
# 
...
#
# Input Source: Test Case Inputs/BASE-YRD-1020.csv
# Required Inputs:
...
#
############################################################
Feature: BASE-YRD-1020 Web Inbound Trailer Check In
...
Given I "setup the environment"
	...
	Then I assign "BASE-YRD-1020" to variable "test_case"
...
@BASE-YRD-1020
Scenario Outline: BASE-YRD-1020 Web Inbound Trailer Check In
CSV Examples: Test Case Inputs/BASE-YRD-1020.csv
...
When I execute scenario "Web Verify Inbound Trailer Check In"
