...
############################################################ 
# Test Case: BASE-PRD-6010 Flow Mobile Work Order.feature
# 
...
# 
# Input Source: Test Case Inputs/BASE-PRD-6010.csv
# Required Inputs:
...
# 
############################################################ 
Feature: BASE-PRD-6010 Flow Mobile Work Order
...
Given I "setup the environment"
	...
	Given I execute scenario "Work Order Mobile Imports"
	Then I execute scenario "Web Environment Setup"

	And I assign "BASE-PRD-6010" to variable "test_case"
...
@BASE-PRD-6010
Scenario Outline: BASE-PRD-6010 Flow Mobile Work Order
CSV Examples: Test Case Inputs/BASE-PRD-6010.csv
...
Then I execute scenario "Web Logout"
...
And I execute scenario "Mobile Pick Work Order"
...
Given I execute scenario "Web Logout"

Then I execute scenario "Mobile Login"
And I execute scenario "Mobile Move Inventory to Workstation"
And I execute scenario "Mobile Receive Finished Goods"
Then I execute scenario "Mobile Logout"
