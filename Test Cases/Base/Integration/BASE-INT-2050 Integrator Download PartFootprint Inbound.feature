...
############################################################ 
# Test Case: BASE-INT-2050 Integrator Download PartFootprint Inbound.feature
# 
...
#
# Input Source: Test Case Inputs/BASE-INT-2050.csv
# Required Inputs:
...
#
# Input Detail Source: Test Case Inputs/Details/BASE-INT-2050-01.csv
...
#
############################################################
Feature: BASE-INT-2050 Integrator Download PartFootprint Inbound
...
Given I "setup the environment"
	...
	Then I assign "BASE-INT-2050" to variable "test_case"
	When I execute scenario "Test Data Triggers"

And I "cleanup the dataset, since there was no initial dataset to load"
	Then I assign "Int_PartFoot_Inbound" to variable "cleanup_directory"
...
@BASE-INT-2050
Scenario Outline: BASE-INT-2050 Integrator Download PartFootprint Inbound
CSV Examples: Test Case Inputs/BASE-INT-2050.csv
