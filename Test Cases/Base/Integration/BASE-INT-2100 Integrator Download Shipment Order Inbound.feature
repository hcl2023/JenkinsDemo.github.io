...
############################################################ 
# Test Case: BASE-INT-2100 Integrator Download Shipment Order Inbound.feature
#
...
#
# Input Source: Test Case Inputs/BASE-INT-2100.csv
# Required Inputs:
...
#
# Input Detail Source: Test Case Inputs/Details/BASE-INT-2100-01.csv
...
#
############################################################
Feature: BASE-INT-2100 Integrator Download Shipment Order Inbound
...
Given I "setup the environment"
	...
	Then I assign "BASE-INT-2100" to variable "test_case"
	When I execute scenario "Test Data Triggers"

And I "cleanup the dataset, since there was no initial dataset to load"
	Then I assign "Int_ShpOrd_Inbound" to variable "cleanup_directory"
...
@BASE-INT-02100
Scenario Outline: BASE-INT-2100 Integrator Download Shipment Order Inbound
CSV Examples: Test Case Inputs/BASE-INT-2100.csv
