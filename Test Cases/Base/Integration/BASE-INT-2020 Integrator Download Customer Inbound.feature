...
############################################################ 
# Test Case: BASE-INT-2020 Integrator Download Customer Inbound.feature
#
# Description: 
...
#
# Input Source: Test Case Inputs/BASE-INT-2020.csv
# Required Inputs:
...
#	None
#
# Input Detail Source: Test Case Inputs/Details/BASE-INT-2020-01.csv
...
#
############################################################
Feature: BASE-INT-2020 Integrator Download Customer Inbound
...
Given I "setup the environment"
	...
	Then I assign "BASE-INT-2020" to variable "test_case"
	When I execute scenario "Test Data Triggers"

And I "cleanup the dataset, since there was no initial dataset to load"
	Then I assign "Int_Customer_Inbound" to variable "cleanup_directory"
...
@BASE-INT-2020
Scenario Outline: BASE-INT-2020 Integrator Download Customer Inbound
CSV Examples: Test Case Inputs/BASE-INT-2020.csv
