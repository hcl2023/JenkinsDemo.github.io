...
############################################################ 
# Test Case: BASE-INT-2010 Integrator Download ASN Inbound.feature
#
...
#
# Input Source: Test Case Inputs/BASE-INT-2010.csv
# Required Inputs:
...
#	None
#
# Input Detail Source: Test Case Inputs/Details/BASE-INT-2010-01.csv
...
#
############################################################
Feature: BASE-INT-2010 Integrator Download ASN Inbound
...
Given I "setup the environment"
	...
	Then I assign "BASE-INT-2010" to variable "test_case"
	When I execute scenario "Test Data Triggers"

And I "cleanup the dataset, since there was no initial dataset to load"
	Then I assign "Int_ASN_Download" to variable "cleanup_directory"
...
@BASE-INT-2010
Scenario Outline: BASE-INT-2010 Integrator Download ASN Inbound
CSV Examples: Test Case Inputs/BASE-INT-2010.csv
