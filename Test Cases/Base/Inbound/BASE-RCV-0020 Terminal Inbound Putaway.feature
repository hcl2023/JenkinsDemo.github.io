...
############################################################ 
# Test Case: BASE-RCV-0020 Terminal Inbound Putaway.feature
# 
...
#
# Input Source: Test Case Inputs/BASE-RCV-0020.csv
# Required Inputs:
# 	wh_id - Warehouse ID
...
#
############################################################
Feature: BASE-RCV-0020 Terminal Inbound Putaway
...
Given I "setup the environment"
	...
	Then I assign "BASE-RCV-0020" to variable "test_case"
...
@BASE-RCV-0020
Scenario Outline: BASE-RCV-0020 Terminal Inbound Putaway
CSV Examples: Test Case Inputs/BASE-RCV-0020.csv
...
When I "Perform the Putaway"
	...
	And I execute scenario "Terminal Undirected Putaway"
