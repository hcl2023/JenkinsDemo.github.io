...
############################################################ 
# Test Case: BASE-RCV-4030 Mobile Inbound Reverse Receiving.feature
# 
...
#
# Description: Performs Mobile Reverse Receiving
#
# Input Source: Test Case Inputs/BASE-RCV-4030.csv
# Required Inputs:
...
#
############################################################
Feature: BASE-RCV-4030 Mobile Inbound Reverse Receiving
...
Given I "setup the environment"
	...
	Then I assign "BASE-RCV-4030" to variable "test_case"
...
@BASE-RCV-4030
Scenario Outline: BASE-RCV-4030 Mobile Inbound Reverse Receiving
CSV Examples: Test Case Inputs/BASE-RCV-4030.csv
...
Then I "open the Mobile App Receiving Menu"
	...
	And I execute scenario "Mobile LPN Reverse Receipt Menu"

When I "reverse the Receipt"
	And I execute scenario "Mobile Reverse Receipt"
