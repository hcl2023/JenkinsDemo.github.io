...
############################################################ 
# Test Case: BASE-RCV-0070 Terminal Inbound Unload All.feature
# 
...
#
# Input Source: Test Case Inputs/BASE-RCV-0070.csv
# Required Inputs:
...
#
############################################################
Feature: BASE-RCV-0070 Terminal Inbound Unload All
...
Given I "setup the environment"
	...
	Then I assign "BASE-RCV-0070" to variable "test_case"
...
@BASE-RCV-0070
Scenario Outline: BASE-RCV-0070 Terminal Inbound Unload All
CSV Examples: Test Case Inputs/BASE-RCV-0070.csv

Given I "execute pre-test scenario actions (including pre-validations)"
	And I execute scenario "Begin Pre-Test Activities"

Then I "login to the terminal and navigate to the Unload Ship Screen"
	Then I execute scenario "Terminal Login"
    And I execute scenario "Terminal Receiving Unload Shipment Menu"
    
When I "unload the shipment and dispatch the equipment"
    Then I execute scenario "Terminal Unload Shipment"
	And I execute scenario "Terminal Process Workflow"
    And I execute scenario "Terminal Confirm Dispatch Equipment"
    And I execute scenario "Terminal Dispatch Equipment"
