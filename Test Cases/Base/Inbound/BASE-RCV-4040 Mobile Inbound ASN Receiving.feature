...
############################################################ 
# Test Case: BASE-RCV-4040 Mobile Inbound ASN Receiving.feature
# 
...
#
# Input Source: Test Case Inputs/BASE-RCV-4040.csv
# Required Inputs:
...
#
############################################################
Feature: BASE-RCV-4040 Mobile Inbound ASN Receiving
...
Given I "setup the environment"
	...
	Then I assign "BASE-RCV-4040" to variable "test_case"
...
@BASE-RCV-4040
Scenario Outline: BASE-RCV-4040 Mobile Inbound ASN Receiving
CSV Examples: Test Case Inputs/BASE-RCV-4040.csv
...
When I "open the Receipt, process workflow, receive each receipt line individually, and deposit to location"
	...
	When I "perform Receiving (ASN)"
		Then I execute scenario "Mobile ASN Receiving"
