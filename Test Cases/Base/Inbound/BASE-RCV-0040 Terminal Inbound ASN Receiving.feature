...
############################################################ 
# Test Case: BASE-RCV-0040 Terminal Inbound ASN Receiving.feature
# 
...
#
# Input Source: Test Case Inputs/BASE-RCV-0040.csv
# Required Inputs:
...
#	Example Row: CRDL_TO_GRAVE detail level serialized prtnum being received and requiring serial numbers to be associated to ASN (quantity 10)
#	Example Row: CRDL_TO_GRAVE serialized prtnum being received and requiring serial numbers to be associated to ASN (quantity 50)
#	Example Row: OUTCAP_ONLY serialized prtnum being received (should not require serial numbers to be added) 
...
#
############################################################
Feature: BASE-RCV-0040 Terminal Inbound ASN Receiving
...
Given I "setup the environment"
	...
	Then I assign "BASE-RCV-0040" to variable "test_case"
...
@BASE-RCV-0040
Scenario Outline: BASE-RCV-0040 Terminal Inbound ASN Receiving
CSV Examples: Test Case Inputs/BASE-RCV-0040.csv
...
When I "open the Receipt, process workflow, receive each receipt line individually, and deposit to location"
	...
	When I "perform Receiving (ASN)"
		Then I execute scenario "Terminal ASN Receiving"
