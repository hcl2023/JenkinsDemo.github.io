...
############################################################ 
# Test Case: BASE-RCV-4060 Mobile Inbound ASN Receiving Non Trusted Supplier.feature
# 
...
#
# Input Source: Test Case Inputs/BASE-RCV-4060.csv
# Required Inputs:
...
#
############################################################
Feature: BASE-RCV-4060 Mobile Inbound ASN Receiving Non Trusted Supplier
...
Given I "setup the environment"
	...
	Then I assign "BASE-RCV-4060" to variable "test_case"
...
@BASE-RCV-4060
Scenario Outline: BASE-RCV-4060 Mobile Inbound ASN Receiving Non Trusted Supplier
CSV Examples: Test Case Inputs/BASE-RCV-4060.csv
...
When I "open the Receipt, process workflow, receive each receipt line individually, and deposit to location"
	...
	When I "perform Receiving (ASN) from a non-trusted supplier"
		Then I execute scenario "Mobile ASN Receiving Non-Trusted Supplier"
