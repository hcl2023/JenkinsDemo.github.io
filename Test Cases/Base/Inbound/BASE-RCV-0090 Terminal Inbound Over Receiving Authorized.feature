...
############################################################ 
# Test Case: BASE-RCV-0090 Terminal Inbound Over Receiving Authorized.feature
# 
...
# 
# Description:
# This Test Case generates a receipt via MSQL and receives it. It will over receive based on expqty and rec_qty inputs and user will have permissions/role to do the over receive.
#
# Input Source: Test Case Inputs/BASE-RCV-0090.csv
# Required Inputs:
...
#
############################################################
Feature: BASE-RCV-0090 Terminal Inbound Over Receiving Authorized
...
Given I "setup the environment"
	...
	Then I assign "BASE-RCV-0090" to variable "test_case"
...
@BASE-RCV-0090
Scenario Outline: BASE-RCV-0090 Terminal Inbound Over Receiving Authorized
CSV Examples: Test Case Inputs/BASE-RCV-0090.csv
