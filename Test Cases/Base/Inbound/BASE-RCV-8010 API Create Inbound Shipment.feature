...
############################################################ 
# Test Case: BASE-RCV-8010 API Create Inbound Shipment.feature
# 
...
#
# Input Source: Test Case Inputs/BASE-RCV-8010.csv
# Required Inputs:
...
#
############################################################
Feature: BASE-RCV-8010 API Create Inbound Shipment
...
Given I "setup the environment"
	...
	Then I assign "BASE-RCV-8010" to variable "test_case"
...
@BASE-RCV-8010
Scenario Outline: BASE-RCV-8010 API Create Inbound Shipment
CSV Examples: Test Case Inputs/BASE-RCV-8010.csv

Given I "execute pre-test scenario actions (including pre-validations)"
	And I execute scenario "Begin Pre-Test Activities"

Given I execute scenario "API Create Inbound Shipment"
